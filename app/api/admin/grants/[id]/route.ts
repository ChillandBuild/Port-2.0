...
import { extendGrant, setGrantRevoked } from "@/lib/backend/course-grants";
import { clampAccessSeconds, durationToSeconds, presetById } from "@/lib/course-duration";

export const runtime = "nodejs";

/**
 * Acts on one grant: extend, revoke, restore.
 *
 * One handler rather than three sibling routes — the auth guard, the id
 * lookup and the error mapping are identical, and splitting them would mean
 * three places to forget requireAdmin().
 */
