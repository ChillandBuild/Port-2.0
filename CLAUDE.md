...
2.  **Invariants, Tech Stack & File Map**:
    ...
    *   Read when: Touching the world/motion engine, design tokens, accessibility, or the copy/content pipeline.
...
5.  **Subsystem Notes & Load-Bearing Gotchas**:
    ...
    *   Read when: Editing the world engine, `lab/` scripts, or copy vs. design boundaries — holds the *why* and traps the code can't.
